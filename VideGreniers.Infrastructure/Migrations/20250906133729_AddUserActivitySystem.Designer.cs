...
namespace VideGreniers.Infrastructure.Migrations
{
    ...
    [Migration("20250906133729_AddUserActivitySystem")]
    partial class AddUserActivitySystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideGreniers.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VideGreniers.Domain.Entities.UserActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EventId", "ActivityType")
            ...
            modelBuilder.Entity("VideGreniers.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
