        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateRange_StartDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    DateRange_EndDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ...
                    EntryFee_Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    EntryFee_Currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    AllowsEarlyBird = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    EarlyBirdTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    EarlyBirdFee_Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    EarlyBirdFee_Currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_CreatedOnUtc",
                table: "Favorites",
                column: "CreatedOnUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_EventId_Unique",
                table: "Favorites",
